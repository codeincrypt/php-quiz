			<nav class = "navbar navbar-header navbar-light bg-new">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<p class = "navbar-text pull-right text-white"><h3 class="text-white">HIT QUIZ</h3></p>
				</div>
				<div class = "nav navbar-nav navbar-right">
					<a href="logout.php" class="text-light"><?php echo $name ?> <i class="fa fa-power-off"></i></a>
				</div>
			</div>
		</nav>
